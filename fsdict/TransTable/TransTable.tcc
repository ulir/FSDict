#if 1
#ifndef FSDICT_TRANSTABLE_TCC
#define FSDICT_TRANSTABLE_TCC FSDICT_TRANSTABLE_TCC
...
//	    std::cerr << "ffc hack: " << firstFreeCell_ << std::endl;
	...
	if ( header_.getCType() != CellTypeValue ) {
	    ...
	    throw exceptions::badDictFile( "fsdict::TransTable - File is incompatible to dictionary type.\n" );
	}
