#ifndef FSDICT_TEST_PATTERN_H
#define FSDICT_TEST_PATTERN_H FSDICT_TEST_PATTERN_H
...
namespace fsdict {
	...
	PatternProbabilities pp;
	ci.connectPatternProbabilities( pp );
	pp.setDefault( fsdict::PatternWeights::PatternType( 1, 1 ), 1e-5 );
	pp.setDefault( fsdict::PatternWeights::PatternType( 2, 1 ), 1e-5 );
	pp.setDefault( fsdict::PatternWeights::PatternType( 1, 2 ), 1e-5 );
