#ifndef FSDICT_PATTERNGRAPH_H
#define FSDICT_PATTERNGRAPH_H FSDICT_PATTERNGRAPH_H
...
//		return std2custom_.at( c );
	...
	public:
		...
		if( targetStateIndex == 0 ) {
		    throw std::runtime_error( "fsdict::PatternGraph::setTransition: Removing a transition (set target to 0 ) is not supported" );
		}
