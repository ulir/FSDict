#ifndef FSDICT_INTERPRETATION_H
#define FSDICT_INTERPRETATION_H FSDICT_INTERPRETATION_H
...
namespace std {
    inline wostream& operator<<( wostream& os, fsdict::Interpretation const& obj ) {
	obj.print( os );
	return os;
    }
}
