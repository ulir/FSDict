#ifndef FSDICT_ANNOTATEDDICTMODULE_H
#define FSDICT_ANNOTATEDDICTMODULE_H FSDICT_ANNOTATEDDICTMODULE_H
...
namespace fsdict {
	 ...
	 */
	AnnotatedDictModule( fsdict::DictSearch& myDictSearch, std::wstring const& name, std::string const& dicFile, size_t cascadeRank = 0 ) :
	 ...
	 * Note that all options belongto the namespace fsdict::Global.
	 *
	 */
