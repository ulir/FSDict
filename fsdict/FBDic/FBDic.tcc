#ifndef FSDICT_FBDIC_TCC
#define FSDICT_FBDIC_TCC FSDICT_FBDIC_TCC
...
namespace fsdict {
	...
	if( fread( &header_, sizeof( Header ), 1, fi ) != 1 ) {
	  throw exceptions::badDictFile( "fsdict::FBDic::loadFromStream: Read error while reading header" );
	}
